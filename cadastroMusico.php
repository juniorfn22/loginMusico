                ...
                <div class="column is-4 is-offset-4">
                    ...
                    <div class="box">
                        <form action="cadastrar.php" method="POST">
                            <div class="field">
                                <div class="control">
                                    <input name="nome" type="text" class="input is-large" style="color:black;" placeholder="Nome" autofocus>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control">
                                    <input name="usuario" type="text" class="input is-large" style="color:black;" placeholder="Usuário">
                                </div>
                            </div>
                            <div class="field">
                                <div class="control">
                                    <input name="senha" class="input is-large" style="color:black;"  type="password" placeholder="Senha">
                                </div>
                            </div>
                            <div class="fiel">
                                <div class="control">
